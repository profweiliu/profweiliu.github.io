...
- <i class="fa fa-square-o" aria-hidden="true"></i> PPM 504 Perspectives on Institutions 
- <i class="fa fa-check-square-o" aria-hidden="true"></i> PPM 506 Microeconomics for Policy Analysis 
...
- <i class="fa fa-check-square-o" aria-hidden="true"></i> [URBAN 566 Infrastructure Planning and Finance](https://uil.be.uw.edu/education/infrastructure-planning-and-finance/)
- <i class="fa fa-check-square-o" aria-hidden="true"></i> [URBAN 598 Urban Climate Solution](https://uil.be.uw.edu/education/urban-climate-solutions/)
...
- <i class="fa fa-check-square-o" aria-hidden="true"></i> STAT 513 Statistical Inference 2
- <i class="fa fa-check-square-o" aria-hidden="true"></i> STAT 534 Statistical Computing
...
- <i class="fa fa-check-square-o" aria-hidden="true"></i> CSE 574 Explainable AI
- CSE 576 Computer Vision
- CSE 578 Convex Optimization
- <i class="fa fa-check-square-o" aria-hidden="true"></i> [CSE 583 Software Development for Data Scientists](http://uwseds.github.io/syllabus.html)
...
- <i class="fa fa-check-square-o" aria-hidden="true"></i> CET 599 Machine Learning for Civil Engineering
- <i class="fa fa-check-square-o" aria-hidden="true"></i> [CEWA 567 Geospatial Data Analysis with Python](https://github.com/UW-GDA/gda_course_2020)

#### AI and Society 

- CSE 580 Computing for Social Good 
- CSE 582 Ethics in Artificial Intelligence 
- <i class="fa fa-check-square-o" aria-hidden="true"></i> GEOG 521 Critical Geographic Information System
...
#### Master of Urban Planning - Urban Analytics
...
- URBAN 500 Survey of Urban Planning 4
- URBAN 520 Quantitative Methods in Urban Design and Planning 4 (*Waive if you have a statistics foundation*)
- URBAN 527 History, Ethics, Form, and Theory 4
- **CSE 583 Software Development for Data Scientists 4**
- **STAT 509 Introduction to Mathematical Statistics 4**

##### First Year: Winter

- URBAN 501 Comprehensive Planning and Implementation 4
- URBAN 506 Planning Studio Prep 3
- URBAN 528 History, Ethics, Form, and Theory 4
- URBAN 573 Digital Design Practicum 4 (*Waive if you have a design background*)
- **CSE 414 Database Systems 4**

##### First Year: Spring

- URBAN 507 Urban Planning Studio 5
- **CSE 512 Data Visualization 4**
- **URBAN 522 Urban and Regional Geospatial Analysis 4** *OR* **CEWA567 Geospatial Data Analysis with Python 4**

##### Second Year: Autumn

- URBAN 598 Research Design for Urban Science 4
- **CSE 416 Machine Learning 4**

##### Second Year: Winter

- URBAN 700 Master’s Thesis on Urban Analytics 4
- **CSE 517 Natural Language Processing 4** *OR* **CSE 493G1 Deep Learning 4**

##### Second Year: Spring

- URBAN 700 Master’s Thesis on Urban Analytics 5
- URBAN 580 Legal and Administrative Framework for Planning 3